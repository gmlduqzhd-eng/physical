...
export const SquatCounter = ({ groupId, enqueueAction }: Props) => {
  ...
  return (
    <div className={`min-h-[100dvh] bg-purple-950 flex flex-col items-center justify-center p-6 relative overflow-hidden z-[9999] select-none`}>
      ...
      <p className="text-purple-300 font-bold mb-4 text-center text-sm">폰을 가슴에 대고 스쿼트하세요!</p>
      <div className="text-2xl font-black text-purple-400">{phase === 'down' ? '⬇️ 내려가는 중...' : '⬆️ 올라오세요!'}</div>
