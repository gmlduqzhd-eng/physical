...
export const RunInPlace = ({ groupId, enqueueAction }: Props) => {
  ...
  return (
    <div className="min-h-[100dvh] bg-green-950 flex flex-col items-center justify-center p-6 relative overflow-hidden z-[9999] select-none">
      ...
      <p className="text-green-300 font-bold mb-4 text-center text-sm">폰을 손에 들고 제자리에서 뛰세요!</p>
      ...
      <p className="text-green-500 text-xs mt-2 font-bold">목표: 50걸음!</p>
